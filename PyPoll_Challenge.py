...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in counties_dict:
        ...
        county_vote_percentage = "{:.1%}".format(float(county_votes) / float(total_votes))

        county_results = (f"{county_name}: {county_vote_percentage} ({county_votes})\n")
        ...
        if (county_votes > most_votes_county): 
            most_votes_county = county_votes
    ...
    county_votes_summary = (
        ...
        f'Vote count for county: {most_votes_county:,}\n\n'
        f'Percentage of votes: {largest_county_percentage}\n'
        f'---------------------------\n')
